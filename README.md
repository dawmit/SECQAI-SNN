...
You will want to create your own `venv`, to create your own virtual environment to easily install the packages using `pip`.

Clone the github:

`git clone https://github.com/dawmit/SECQAI-SNN.git`

And run the app, within the python virtual environment:
